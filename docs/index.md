...
<div style="background:#e8f5e9;border-left:4px solid #4caf50;padding:12px;margin:12px 0;">
  <p>🎁 <b>8折码：</b><code style="background:#fff;padding:3px 10px;color:#d32f2f;font-weight:bold;">100188</code> ｜ <a href="https://gptvpnhelper.com/airport-access/xmf/" target="_blank" style="color:#1976d2;">👉 完整测评</a></p>
</div>
...
<div style="background:#fff3cd;border-left:4px solid #ffc107;padding:12px;margin:12px 0;">
  <p>🎁 <b>8折码：</b><code style="background:#fff;padding:3px 10px;color:#d63031;font-weight:bold;">10180</code>（至11.1）｜ <a href="https://ivt02.qytaff.cc/register?aff=zcIlh0VY" target="_blank" style="color:#1976d2;">👉 官网注册</a></p>
</div>
...
<div style="background:#fff3e0;border-left:4px solid #ff9800;padding:12px;margin:12px 0;">
  <p>🎁 <b>8折码：</b><code style="background:#fff;padding:3px 10px;color:#d32f2f;font-weight:bold;">2510815</code> ｜ <a href="https://gptvpnhelper.com/airport-access/tntcloud/" target="_blank" style="color:#1976d2;">👉 完整测评</a></p>
</div>
...
<div style="background:#fff3cd;border-left:4px solid #ffc107;padding:15px;margin:15px 0;">
  ...
  <p><small>年付小包不参加；不限使用次数；可与套餐活动叠加享折上折。</small></p>
</div>
