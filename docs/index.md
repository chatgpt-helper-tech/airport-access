...
**综合评分：8.8 / 10**  
**关键词**：2017 老牌｜SS+Vmess｜海外可用｜不限客户端

| 指标 | 数据 |
| :-- | :-- |
| 开业 | 2017 |
| 入口 | CDN 优选，多入口智能接入（江苏/河北/广东） |
| 过境 | IEPL 专线 |
| 协议 | Shadowsocks + Vmess |
| 客户端数 | 不限（适合路由器/多设备） |
| 流媒体 | Netflix/Disney+/Hulu/AbemaTV 等多国解锁 |
| ChatGPT | 全节点解锁，延迟 200‑250 ms |
| 支付 | 支付宝 / USDT / 信用卡 |

**套餐亮点**  
- **Mini**：10 GB/月 ¥150/年（超轻量备用）  
- **Basic**：50 GB/月 ¥75/季  
- **Ultimate1**：300 GB/年 ¥598  
- 团队 1 TB/月 ¥510/季，可创建子账号
...
| Kycloud | 不限设备 | SS/Vmess | ¥75/季 | 50 GB | 多入口 IEPL | 多区 4K | 全解锁 | ∞ |
